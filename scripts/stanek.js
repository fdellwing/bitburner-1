import { getNsDataThroughFile, disableLogs, formatNumberShort, formatRam, getFilePath, waitForProcessToComplete, log } from './bs-helpers.js'

// Default scripts called at startup and shutdown of stanek
//const defaultStartupScript = getFilePath('infinity-spinup.js');
//const defaultStartupArgs = ['--reserved-ram', Number.MAX_SAFE_INTEGER];
//const defaultStartupArgs = [];
//const defaultCompletionScript = getFilePath('infinity-spinup.js');
